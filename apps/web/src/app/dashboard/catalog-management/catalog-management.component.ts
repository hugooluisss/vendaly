...
export class CatalogManagementComponent {
  ...
  businessId = 0; published = false; hasCoordinates = false; publishError = ''; categories: Category[] = []; products: Product[] = []; newCategory = ''; editingCategory?: Category; editingProduct?: Product; image?: File; ingredientInput = '';
