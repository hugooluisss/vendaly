...
**Reason**: Modal-gated filtering added an extra step and read as a mobile-only pattern; replaced by always-visible floating category filter chips and a visible name search input.
