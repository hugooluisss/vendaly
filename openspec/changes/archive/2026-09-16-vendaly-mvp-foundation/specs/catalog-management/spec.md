...
The system SHALL allow the business owner to create a product or service with a name, description, optional image, optional price, and an availability flag, assigned to one category within their business.
