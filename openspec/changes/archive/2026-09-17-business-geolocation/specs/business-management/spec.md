...
The system SHALL allow the business owner to set and update the business's name, logo, WhatsApp number, description, category, location, and coordinates (latitude/longitude).

#### Scenario: Update profile fields
- **WHEN** the business owner submits updated name, logo, WhatsApp number, description, category, location, and/or coordinates
